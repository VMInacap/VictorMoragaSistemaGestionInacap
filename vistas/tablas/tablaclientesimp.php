...
$c=new conectar();
$conexion=$c->conexion();
$sql="SELECT clientes.id, clientes.nombre, clientes.apepat, clientes.apemat, clientes.RUN, clientes.telefono, clientes.direccion, clientes.email, clientes.estado_civil, causas.rol, causas.pago FROM clientes"
